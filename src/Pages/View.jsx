...
function View() {
  ...
  return (
    <>
    <Header/>
    <div style={{marginTop:'150px'}} className='container align-items-center'>
      <div className='row mb-5 align-items-center'>
        <div className="col-lg-6">
          <img style={{width:'400px'}} className='img-fluid' src={product?.thumbnail} alt="" />
        </div>
        ...
        <div className="col-lg-6">
          ...
          <div className="d-flex justify-content-between">
            <button onClick={()=>handleWishlist(product)} className='btn btn-outline-dark'> <i class="fa-solid fa-heart text-primary"></i> Add To Wishlist </button>
